...
def loaditems(bg):
    ...
    for i in range(len(x)):
        itemlist.append(item(can,copy.deepcopy(idic[x[i][0]])))
...
def start(initial=True,abg=0,):
    global chs,cvs,exits,bg,player1,vescroll,hoscroll,can,keyset,direction,bgdic,uwl,lwl,uvl,lvl,speed,itemlist
    itemlist = []
    speed = 7
    uwl = 320
    lwl = 280
